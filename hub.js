(function () {
    ...
    // --- API и Константы ---
    const FLASK_API_BASE = "http://qipparu.duckdns.org/scraper";
    ...
    const PROXY_FOR_EXTERNAL_URLS = "http://qipparu.duckdns.org/proxy/proxy?url=";
        ...
        this.appendCardsToDOM = function (metasToAppend, originalApiBatchLength, isEmptyAfterFilter = false) {
            ...
            metasToAppend.forEach(meta => {
                ...
                card_render.on("hover:enter", () => {
                    ...
                    network.native(streamsUrl,fr=>{this.activity.loader(false);if(fr&&fr.streams&&fr.streams.length>0){
